    ...
    slides = [
      {
        ...
        "styleTitle": const TextStyle(color: Color.fromARGB(255, 4, 34, 59), fontSize: 30, fontFamily: 'Poppins', fontStyle: FontStyle.normal, fontWeight: FontWeight.bold),
        "styleDescription": const TextStyle(color: Color.fromARGB(255, 32, 125, 232), fontSize: 20, fontFamily: 'Helvetica', fontStyle: FontStyle.italic, fontWeight: FontWeight.bold),
      },
      {
